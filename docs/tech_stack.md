...
| **Open-Meteo Weather API** | Live weather forecasting & solar radiation data source. | Provides free global solar irradiance (W/m²), 7-day daily forecasts, and cloud cover percentage without requiring complex API keys. |
